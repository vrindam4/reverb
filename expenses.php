...
<script type="text/javascript">
    ...
    function change_table() {
        t1 = document.getElementById("expenses");
        t2 = document.getElementById("expenses1");
        if(visible == 1) {
            visible = 2;
            ...
            <div class="content">
                <div class="row">
                    ...
                    <div class="col-sm-8 col-9 text-right m-b-20">
                        <a href="inventory.php" class="btn btn-primary float-right btn-rounded"><i class="fa fa-plus"></i> Add Expenses</a>
                    </div>
                </div>
                ...
                <div class="row filter-row">
                    <div class="col-sm-6 col-md-3">
                        <div class="form-group form-focus">
                            <label style="margin-right: 20px">Item</label>
                                        <input class="form-control" type="text" name="name" list="name" >
                                        <datalist id="name">
                                            <?php
                                                $query = "SELECT distinct inv_name FROM inventory";
                                                $query_run = mysqli_query($con,$query);
                                                while ($row = mysqli_fetch_array($query_run)){?>
                                                    <option value="<?php echo $row['inv_name'] ?>">
                                                <?php } ?>
                                        </datalist>
                        </div>
                    </div>
                    <div class="col-sm-6 col-md-3">
                        <div class="form-group form-focus">
                           <label style="margin-right: 20px">Purchased By</label>
                                        <input class="form-control" type="text" name="pur_by" list="pur_by" >
                                        <datalist id="pur_by">
                                            <?php
                                                $query = "SELECT distinct purchased_by FROM inventory";
                                                $query_run = mysqli_query($con,$query);
                                                while ($row = mysqli_fetch_array($query_run)){?>
                                                    <option value="<?php echo $row['purchased_by'] ?>">
                                                <?php } ?>
                                        </datalist>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-12">
						<div class="table-responsive">
                            <table class="table table-striped custom-table" id="expenses">
                                <thead>
                                    <tr>
                                ...
                                $query = "SELECT * FROM inventory";
                                        ...
                                        while ($res=mysqli_fetch_array($result)) {
                                            $id=$res['inv_id'];
                                            $pur_from=$res['purchased_from'];
                                            $date=$res['date'];
                                            $amount=$res['amount'];
                                            $pur_by1=$res['purchased_by'];
                                            $name= $res['inv_name'];
                                            ?>
                                             <tr>
                                                <td> <?php echo $id; ?></td>
                                                <td> <?php echo $name; ?></td>
                                                <td> <?php echo $pur_from; ?></td>
                                                <td> <?php echo $pur_by1; ?> </td>
                                                <td> <?php echo $date; ?> </td>
                            ...
                            <table class="table table-striped custom-table" id="expenses1">
                                <thead>
                                    <tr>
                                        <th style="min-width:100px;">ID</th>
										<th style="min-width:100px;">Item</th>
								...
								<tbody>
                                    <?php 
										...
										$query = "SELECT inv_id,inv_name,date,purchased_by,purchased_from,amount FROM inventory where inv_name='$name' or purchased_by='$pur_by'";
