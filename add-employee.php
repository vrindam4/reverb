                    ...
                    <div class="col-lg-8 offset-lg-2">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="password" name="cnf_password" required>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <div class="cal-icon">
                                            <input class="form-control datetimepicker" type="text" name="date_of_joining" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" pattern="[1-9]{1}[0-9]{9}" title="Please enter 10 digits" name="phone" required>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" type="text" name="address" required></textarea><br>
                                    </div>
                                </div>
                            </div>
                            
                            <div class="m-t-20 text-center">
                                <button class="btn btn-primary submit-btn" name="create">Create Employee</button>
                            </div>
                        </form>
                        ...
                        if(isset($_POST['create'])){
                            ...
                            if($cnf_password==$password){
                                ...
                                $sql_u = "SELECT * FROM ".$table_name." WHERE uname='$uname'";
                                ...
                                if (mysqli_num_rows($res_u) > 0) {
                                    ...
                                    $query = "INSERT into ".$table_name." values ('$employee_id','$full_name','$email','$uname','$password','$gender','$date_of_joining','$phone','$role','$address');";
                                    $query_run = mysqli_query($con,$query);

                                    if($query_run){
                                        echo '<script type ="text/javascript"> alert("Successful created account with Doctor ID: '.$employee_id.'")</script>';
