...
$query="select * from salary where emp_id='$emp_id' and date='$date_slip'";
$query_run = mysqli_query($con,$query);
while($row=mysqli_fetch_array($query_run)){
$date = $row['date'];
$basic = $row['basic'];
        ...
        <div class="page-wrapper">
            <div class="content">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card-box">
                            <h4 class="payslip-title">Payslip for period <?php echo $date_slip ?></h4>
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-lg-12 m-b-20">
                                    <ul class="list-unstyled">
                                        ...
                                        <li>Joining Date: <?php echo $date_of_joining ?></li>
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div>
                                        ...
                                        <table class="table table-bordered">
                                            <tbody>
                                                <tr>
                                                    <td><strong>Basic Salary</strong> <span class="float-right"><?php echo $basic ?></span></td>
                                                </tr>
                                                <tr>
                                                    <td><strong>Dearness Allowance</strong> <span class="float-right"><?php echo $da ?></span></td>
                                                </tr>
                                                <tr>
                                                    <td><strong>Home Rent Allowance</strong> <span class="float-right"><?php echo $hra ?></span></td>
                                                </tr>
                                                <tr>
                                                    <td><strong>Medical Allowance</strong> <span class="float-right"><?php echo $ma ?></span></td>
                                                </tr>
                                                <tr>
                                                    <td><strong>Total Earnings</strong> <span class="float-right"><strong><?php echo $earning ?></strong></span></td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
                                ...
                                <div class="col-sm-6">
                                    <div>
                                        ...
                                        <table class="table table-bordered">
                                            <tbody>
                                                <tr>
                                                    <td><strong>Provident Fund</strong> <span class="float-right"><?php echo $pf ?></span></td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
                                ...
                                <div class="col-sm-12">
                                    <center>
                                        <h4><strong>Net Salary: <?php echo $amount ?></strong></h4>
                                    </center>
                                </div>
                            </div>
                        </div>
