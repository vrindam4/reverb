                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card-box">
                            ...
                            <div class="row">
								...
								$query= "SELECT  * from pharm_purchase where bill_id='$bill_id'";  
                                ...
                                ?>
								 <div class="col-sm-6 m-b-20">
                                    ...
                                    <div class="invoice-details">
                                        ...
                                        <h4 class="text-uppercase">Bill No: <?php echo $bill_id ?></h4>
							...
							<div class="row">
                                ...
                                <div class="col-lg-12 m-b-20">
                                    ...
                                    <ul class="list-unstyled">
                                        ...
                                        <li>Patient Name: <?php echo $r_patient_name?></li>



                                        <li>Doctor Name: <?php echo $r_doctor_name?></li>



                                        <li>Phone: <?php echo $r_phone_no?></li>
