                ...
                <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
								 ...
								 <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" name="doctor_id" value= <?php echo $doctor_id; ?> disabled>
								...
								<div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" name="specialisation" value='<?php echo $specialisation; ?>'>
					...
					<?php
                        ...
                        if(isset($_POST['save'])){
                            ...
                            $query = "UPDATE ".$table_name." SET full_name='$full_name',specialisation='$specialisation',date_of_joining='$date',password='$password',email='$email',phone_no='$phone',address='$address',short_bio='$bio' WHERE doctor_id='$doctor_id';";

                            $query_run = mysqli_query($con,$query);

                            if($query_run){

                                echo '<script type ="text/javascript"> alert("Successful edited account with Doctor ID: '.$doctor_id.'")</script>';
