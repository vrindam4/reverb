        ...
        <div class="sidebar" id="sidebar">
            ...
            <li>
              ...
              <ul style="display: none;">
                ...
                <li class="active"><a href="outpatient_reg.php">OPD</a></li>
            ...
            <div class="content">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 offset-lg-2">
                        ...
                        <h4 class="page-title">Out-Patient Details</h4>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 offset-lg-2">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="cal-icon">
                                            ...
                                            <input class="form-control datetimepicker" type="text" name="date_of_admission" required>
                        ...
                        if(isset($_POST['register'])){
                            ...
                            // $query = "INSERT into ".$table_name." (`patient_id`,`full_name`,`age`,`sex`,`phone_no`,`email`,`address`,`doctor_id`,`diagnosis`,`date_of_admission`,`allergies`,`previous_medication`,`patient_type`) VALUES ('$patient_id','$full_name','$age','$sex','$phone','$email','$address','$doc','$diagnosis','$date_of_admission','$allergies','$previous_medication','OPD');";

                            $query="INSERT INTO `patient` VALUES ('$patient_id', '$full_name', '$age', '$sex', '$phone', '$email', '$address', '$doc', '$diagnosis', '$date_of_admission','$allergies','$previous_medication','','','','OPD');";
                            ...
                            if($query_run){
                                ...
                                echo "<script>location.href='outpatient_reg.php'</script>";
                            }
