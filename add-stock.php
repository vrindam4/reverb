                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 offset-lg-2">
                            ...
                            <div class="row">
								...
								<div class="col-sm-6">
								 ...
								 <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label>Date of Addition <span class="text-danger">*</span></label>

                                        <div class="cal-icon">

                                            <input class="form-control datetimepicker" type="text" name="date_of_addition" required>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="select" name="stock_type" >
                        ...
                        if(isset($_POST['add_stock'])){
                            ...
                            $query = "SELECT stock_id FROM stock where product_name='$product_name'";
                            $result = mysqli_query($con,$query);
                            while ($res=mysqli_fetch_array($result)) {
                                $stock = $res['stock_id'];
                            }
                            ...
                            $query = "INSERT INTO  `stock` VALUES ('$stock_id','$product_name','$supplier_name','$stock_quantity','$value',   
                            '$date_of_addition','$stock_type');";
