                        ...
                        <div class="col-md-4 col-sm-4  col-lg-3">
                            <div class="profile-widget">
                                <div class="doctor-img">
                                    <a class="avatar" href="profile.php?a=<?php echo $doctor_id ?>">
                                ...
                                <div class="dropdown profile-action">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        <a class="dropdown-item" href="edit-doctor.php?a=<?php echo $doctor_id ?>"><i class="fa fa-pencil m-r-5"></i> Edit</a>
                                    </div>
                                </div>
                                <h4 class="doctor-name text-ellipsis">
                                    <a href="profile.php?a=<?php echo $doctor_id ?>">
                                        <?php echo $full_name; ?> 
                                    </a>
                                </h4>
                                <div class="doc-prof">
