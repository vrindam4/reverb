                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <label>Inventory name<span class="text-danger">*</span></label><br>

										<select class="select" name="name" required>
											<option disabled selected>Select Name</option>
											<?php
												
												$records = mysqli_query($con, "SELECT DISTINCT inv_name FROM inventory");  // Use select query here 

												while($data = mysqli_fetch_array($records))
												{
													echo "<option value='". $data['inv_name'] ."'>" .$data['inv_name'] ."</option>";  
												}	
											?>  
										</select>	
