            ...
            <div class="content">
                <div class="row">
                    ...
                    <div class="col-sm-8 col-9 text-right m-b-20">
                        <a href="patient_history.php" class="btn btn-primary float-right btn-rounded"><i class="fa fa-plus"></i> Create New Bill</a>
                    </div>
                </div>
                    ...
                    <div class="col-md-12">
						<div class="table-responsive">
                            <table class="table table-striped custom-table" id="bill">
                                ...
                                $query = "SELECT SUM(amount) AS value_sum,billing_no,patient_id,date from billing GROUP BY billing_no";
                                ...
                                while ($row = mysqli_fetch_array($query_run)){
									...
									$query1="SELECT full_name from patient where patient_id='$patient_id';";
